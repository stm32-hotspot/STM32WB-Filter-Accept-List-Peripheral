...
static void UartCmdExecute(void)
{
  ...
  // Disabled SWx commands for STM32WB5MM-DK
  ...
  if (strcmp((char const*)CommandString, "db") == 0)
  {
    UTIL_SEQ_SetTask(1 << CFG_TASK_BLE_CLEAR_ID, CFG_SCH_PRIO_1);
  }
  else if (strcmp((char const*)CommandString, "pair") == 0)
  {
    app_ble_pairing_request();
  }
  else
  {
